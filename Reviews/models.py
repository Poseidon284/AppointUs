...
class Reviews(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='reviews_by_user', default=get_default_user)
    service = models.ForeignKey(Business, on_delete=models.CASCADE, related_name='reviews_to_service', default=get_default_business)
